...
object BluetoothHidConstants {
     ...
     */
    val FIDO_HID_REPORT_DESCRIPTOR =
        byteArrayOf(
            0x05.toByte(),
            ...
            0x05.toByte(),
            0x07.toByte(), //   Usage Page (Keyboard/Keypad)
            0x19.toByte(),
            0xE0.toByte(), //   Usage Minimum (Keyboard Left Control)
            0x29.toByte(),
            0xE7.toByte(), //   Usage Maximum (Keyboard Right GUI)
            0x15.toByte(),
