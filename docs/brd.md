...
### 5.1 Security
- **NFR-SEC-010**: All sensitive data must be encrypted with AES-256-GCM. If the device supports Quantum-Resistant (Post-Quantum Cryptography) algorithms (e.g., ML-KEM/Kyber), the application must utilize these as the primary encryption method.
