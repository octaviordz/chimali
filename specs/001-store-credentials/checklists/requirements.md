...
- [x] No implementation details (languages, frameworks, APIs) *(Exception: Constitutionally mandated encryption types in NFRs)*
...
- [x] No implementation details leak into specification *(Exception: Constitution rules)*
