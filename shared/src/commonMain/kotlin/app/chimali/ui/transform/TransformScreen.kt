...
private val DrawablesList = listOf(
    Res.drawable.avatar_1, Res.drawable.avatar_2, Res.drawable.avatar_3, Res.drawable.avatar_4,
    Res.drawable.avatar_5, Res.drawable.avatar_6, Res.drawable.avatar_7, Res.drawable.avatar_8,
    Res.drawable.avatar_9, Res.drawable.avatar_10, Res.drawable.avatar_11, Res.drawable.avatar_12,
    Res.drawable.avatar_13, Res.drawable.avatar_14, Res.drawable.avatar_15, Res.drawable.avatar_16
)
...
fun TransformScreen(
    ...
    val columns = if (dimensions.isCompactLayout) {
        GridCells.Fixed(1)
    } else {
