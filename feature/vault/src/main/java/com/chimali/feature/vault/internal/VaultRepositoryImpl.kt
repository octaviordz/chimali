...
class VaultRepositoryImpl(
    ...
    override suspend fun getItems(labelId: UUID?): Outcome<List<VaultItem>, DomainError> = withContext(Dispatchers.IO) {
        try {
    ...
    override suspend fun saveItem(item: VaultItem): Outcome<Unit, DomainError> = withContext(Dispatchers.IO) {
        try {
    ...
    override suspend fun deleteItem(id: UUID): Outcome<Unit, DomainError> = withContext(Dispatchers.IO) {
        try {
