...
@Singleton
class RelyingPartyRepositoryImpl @Inject constructor() : RelyingPartyRepository {
    ...
    override suspend fun updateCredentialCount(rpId: String, count: Int): Result<Unit> {
