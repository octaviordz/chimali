 ...
 */
@Singleton
class UserConsentRecordDao @Inject constructor(
     ...
     */
    fun getRecentConsent(rpId: String?, limit: Int): Flow<List<UserConsentRecordEntity>> {
        return if (rpId != null) {
     ...
     */
    fun getConsentByCredential(credentialId: String, limit: Int): Flow<List<UserConsentRecordEntity>> {
     ...
     */
    fun getConsentByDevice(deviceId: String, limit: Int = 100): Flow<List<UserConsentRecordEntity>> {
     ...
     */
    fun getConsentByIpAddress(ipAddress: String, limit: Int = 100): Flow<List<UserConsentRecordEntity>> {
     ...
     */
    fun getBiometricConsent(rpId: String? = null, limit: Int = 100): Flow<List<UserConsentRecordEntity>> {
        return if (rpId != null) {
     ...
     */
    fun getPinConsent(rpId: String? = null, limit: Int = 100): Flow<List<UserConsentRecordEntity>> {
        return if (rpId != null) {
     ...
     */
    fun getCombinedConsent(rpId: String? = null, limit: Int = 100): Flow<List<UserConsentRecordEntity>> {
        return if (rpId != null) {
     ...
     */
    fun searchConsent(query: String, limit: Int = 100): Flow<List<UserConsentRecordEntity>> {
    ...
    suspend fun getConsentStatisticsByRpId(rpId: String): ConsentStatistics {
        ...
        val registration = database.userConsentRecordQueries.countByOperationAndRpId(
            operationType = ConsentOperationType.REGISTRATION.name,
            rpId = rpId
        ).executeAsOne()
        val authentication = database.userConsentRecordQueries.countByOperationAndRpId(
