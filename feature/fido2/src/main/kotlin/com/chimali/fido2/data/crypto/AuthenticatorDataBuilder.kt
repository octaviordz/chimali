 ...
 */
@Singleton
class AuthenticatorDataBuilder @Inject constructor() {
    ...
    private fun assembleFlags(up: Boolean, uv: Boolean, at: Boolean, ed: Boolean): Byte {
        var flags = 0
    ...
    private fun encodeCounter(signCount: Long): ByteArray = byteArrayOf(
