...
object RegistrationErrorHandler {
     ...
     */
    fun handle(error: Throwable): ErrorUi = when (error) {

        // ── User verification ──────────────────────────────────────────────────
        is Fido2Exception.UserVerificationFailed -> ErrorUi(
        ...
        is Fido2Exception.NoVerificationMethodAvailable -> ErrorUi(
        ...
        is Fido2Exception.ConsentDenied -> ErrorUi(
        ...
        is Fido2Exception.CredentialCreationNotAllowed -> ErrorUi(
        ...
        is Fido2Exception.DuplicateCredentialException -> ErrorUi(
        ...
        is Fido2Exception.TooManyCredentials -> ErrorUi(
        ...
        is Fido2Exception.CryptographicException -> ErrorUi(
        ...
        is Fido2Exception.ConnectionException -> ErrorUi(
        ...
        is Fido2Exception.RegistrationFailed -> ErrorUi(
